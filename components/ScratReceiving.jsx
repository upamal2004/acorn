      ...
      >
        ...
        <g>
          ...
          <path
            ...
            fill="none"
            strokeLinecap="round"
            className="animate_[rod-sway_3s_ease-in-out_infinite]"
          />
          ...
          <path
            ...
            fill="none"
            strokeDasharray="5 2"
            className="animate_[line-reel_3s_linear_infinite]"
          />

          {/* Hook */}
          <g className="animate_[hook-catch_3s_ease-in-out_infinite]">
        ...
        <g className="animate_[money-reel_3s_cubic-bezier(0.4,0,0.2,1)_infinite]">
        ...
        <g className="animate_[scrat-reel_3s_ease-in-out_infinite]">
          {/* Body */}
          <ellipse cx="75" cy="220" rx="30" ry="22" fill="#C4956A" />
          <ellipse cx="78" cy="223" rx="20" ry="14" fill="#E8D4B8" />

          {/* Tail - raised high, wagging */}
          <g className="origin-bottom animate_[tail-wag-fast_0.4s_ease-in-out_infinite]">
          ...
          <g className="animate_[paws-grip_3s_ease-in-out_infinite]">
        ...
        <g className="animate_[money-float_2.5s_ease-in-out_infinite]">
        ...
        <g className="animate_[money-float_2.5s_ease-in-out_infinite_0.7s]">
        ...
        <g className="animate_[money-float_2.5s_ease-in-out_infinite_1.4s]">
